...
locals {
  ...
  minecraft_switch_access_group = "minecraft-ratels@googlegroups.com"
}
...
resource "google_compute_instance" "minecraft" {
  ...
  metadata_startup_script = "docker run --rm --name mcserver -e MEMORYSIZE='1G' -v /home/joe/mcserver:/data:rw -p 25565:25565 -i dotruchon/ratel-minecraf-server-image:0.1"
